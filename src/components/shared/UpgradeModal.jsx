...
var CHECK = React.createElement("svg", { viewBox: "0 0 24 24", width: 15, height: 15, fill: "none", stroke: "currentColor", strokeWidth: 2.5, strokeLinecap: "round", strokeLinejoin: "round" },
  React.createElement("polyline", { points: "20 6 9 17 4 12" })
);
var CROSS = React.createElement("svg", { viewBox: "0 0 24 24", width: 13, height: 13, fill: "none", stroke: "currentColor", strokeWidth: 2.5, strokeLinecap: "round", strokeLinejoin: "round" },
...
function cell(value, tierClass) {
  ...
  return React.createElement("td", { className: "tier-table-cell " + tierClass },
    value
...
function UpgradeModal(props) {
  ...
  function ctaOrBadge(tierKey, tierLabel, ctaClass) {
    ...
    return React.createElement("button", { className: "upgrade-cta " + ctaClass, onClick: onClose }, "Get " + tierLabel);
  }

  return React.createElement("div", { className: "upgrade-overlay", onClick: onClose },
    React.createElement("div", { className: "upgrade-modal tier-table-modal", onClick: function(e) { e.stopPropagation(); } },
      React.createElement("button", { className: "upgrade-close", onClick: onClose }, "\xd7"),
      React.createElement("h2", { className: "upgrade-title", style: { textAlign: "center", marginBottom: 4 } }, "Compare plans"),
      React.createElement("p", { className: "upgrade-desc", style: { textAlign: "center", marginBottom: 20 } },
        "Free gives you one trial scan per tool. Pick the plan that fits how you trade."
      ),
      React.createElement("div", { className: "tier-table-wrap" },
        React.createElement("table", { className: "tier-table" },
          ...
          React.createElement("tbody", null,
            ...
            React.createElement("tr", { className: "tier-table-cta-row" },
              React.createElement("td", null),
              React.createElement("td", { className: "tier-table-cell" }, ctaOrBadge("free", "Free", "")),
              React.createElement("td", { className: "tier-table-cell tier-table-cell-premium" }, ctaOrBadge("premium", "Premium", "")),
              React.createElement("td", { className: "tier-table-cell tier-table-cell-elite" }, ctaOrBadge("elite", "Elite", "tier-table-elite-cta"))
            )
          )
        )
      )
