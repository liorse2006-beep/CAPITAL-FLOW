  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          { className: 'scan-btn', onClick: startScan, disabled: loading },
          loading
            ? React.createElement(
                React.Fragment,
                null,
    ...
    !loading &&
      ...
      React.createElement(
        ...
        React.createElement(
          'p',
          null,
          'Catch unusual volume spikes before the opening bell. Best run between 4:00–9:30 AM ET.'
        )
      ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                sorted.length +
                  ' results · ' +
                  (results.length - sorted.length > 0 ? results.length - sorted.length + ' filtered' : 'all shown')
              )
            ),
            React.createElement(
              'div',
                ...
                sorted.length === 0
                  ...
                  : sorted.map((r, i) =>
                      React.createElement(
                        ...
                        React.createElement(
                          'td',
                          { className: (r.change || 0) >= 0 ? 'col-pos' : 'col-neg' },
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            {
                              className:
                                'ratio-pill ' + (r.volumeRatio >= 5 ? 'hot' : r.volumeRatio >= 2 ? 'warm' : 'ok'),
                            },
