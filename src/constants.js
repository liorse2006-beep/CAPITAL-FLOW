export const COLORS = ["#F59E0B","#22c55e","#06b6d4","#ef4444","#FBBF24","#3b82f6","#ec4899","#f97316","#84cc16","#14b8a6","#64748B"];
...
export const SECTOR_ETFS = [
  ...
  { ticker: "XLI",  color: "#64748B", name: "Industrials",            desc: "Aerospace, defense, machinery, construction, and logistics",
  ...
  { ticker: "XLRE", color: "#0EA5E9", name: "Real Estate",            desc: "REITs — commercial, residential, and specialized real estate",
  ...
  { ticker: "IGV",  color: "#0891B2", name: "Software",               desc: "Enterprise and consumer software, SaaS, and cloud platforms",
